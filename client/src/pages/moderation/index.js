        ...
        return (
            <div className="mod-div">
                <div className="profile-tab-div">
                    <ProfileWidget wallet={this.props.wallet}></ProfileWidget>
                </div>
                <div className="mod-vids-div">
                    {this.state.array.map((allah, key) => {
                        return (<ModVid url="" title={this.state.title[key]} image={allah} id={`hi${key}`} num={key} delete={this.delete} wallet={this.props.wallet}></ModVid>)
                    })}
